...
from task_five.models import Work


def work(request):
    return render_mako_context(request, "/task_five/work_manage.html")

def approval(request):
    return render_mako_context(request, '/task_five/approval_list.html')
